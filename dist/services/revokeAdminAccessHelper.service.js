...
function revokeAdminAccessHelper(id) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            const updatedUser = yield user_model_1.default.findByIdAndUpdate(id, { $pull: { role: "admin" } }, { new: true });
            if (!updatedUser) {
                return {
...
exports.default = revokeAdminAccessHelper;
